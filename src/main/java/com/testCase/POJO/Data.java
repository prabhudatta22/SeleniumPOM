...
public class Data
{
    ...
    public Tax_info getTax_info ()
    {
        return tax_info;
    }

    public void setTax_info (Tax_info tax_info)
    {
    ...
    {
        return "ClassPojo [subscriptions = "+subscriptions+", default_source = "+default_source+", object = "+object+", invoice_prefix = "+invoice_prefix+", sources = "+sources+", currency = "+currency+", discount = "+discount+", id = "+id+", shipping = "+shipping+", tax_info_verification = "+tax_info_verification+", delinquent = "+delinquent+", tax_info = "+tax_info+", business_vat_id = "+business_vat_id+", created = "+created+", email = "+email+", description = "+description+", livemode = "+livemode+", account_balance = "+account_balance+", metadata = "+metadata+"]";
    }
}
